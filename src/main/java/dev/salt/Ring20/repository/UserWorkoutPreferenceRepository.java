...
public interface UserWorkoutPreferenceRepository
        extends JpaRepository<UserWorkoutPreference, Long> {
    List<UserWorkoutPreference> findByUserIdAndPreferenceType(
            Long userId, UserWorkoutPreferenceType preferenceType);
    ...
    void deleteByUserIdAndWorkoutIdAndPreferenceType(
            Long userId, Long workoutId, UserWorkoutPreferenceType preferenceType);
}
