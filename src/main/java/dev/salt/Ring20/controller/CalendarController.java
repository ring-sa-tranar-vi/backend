...
@Tag(
        name = "Calendar",
        description = "Endpoints for retrieving user workout calendar events."
)
public class CalendarController {
    ...
    @Operation(
            ...
            description = "Retrieves a user's workout calendar events for the specified month and year."
    )
