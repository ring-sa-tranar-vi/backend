...
public class OrganizationApplicationController {
    ...
    @Operation(
            ...
            description = "Updates an application status to approved. Used by administrators to approve applications."
    )
    ...
    @Operation(
            ...
            description = "Updates an application status to rejected. Used by administrators to reject applications."
    )
